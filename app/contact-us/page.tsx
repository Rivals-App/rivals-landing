...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0F2841] text-white flex flex-col">
        <Navbar />
              ...
              <div className="bg-gray-800/30 p-8 rounded-lg backdrop-blur-sm border border-gray-700">
                {submitStatus === "success" ? (
                  <div className="text-center py-8">
                    <svg className="mx-auto h-16 w-16 text-[#02F199]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <h3 className="mt-4 text-xl font-medium">Message sent successfully!</h3>
                    <p className="mt-2 text-gray-300">We'll get back to you as soon as possible.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <button
                        ...
                        className={`w-full px-6 py-3 rounded-full font-medium text-[#0c412e] bg-[#02F199] hover:scale-105 transition-all duration-200 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
                      >
                        {isSubmitting ? (
                          <span className="flex items-center justify-center">
                            <svg className="animate-spin -ml-1 mr-2 h-5 w-5 text-[#0c412e]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gray-800/30 p-6 rounded-lg backdrop-blur-sm border border-gray-700">
                <h3 className="text-lg font-medium mb-2 text-[#02F199]">How do I join RIVALS?</h3>
                <p className="text-gray-300">
                  You can join our waitlist by clicking the "Join Waitlist" button. Once we launch, you'll be among the first to be invited.
                </p>
              </div>
              
              <div className="bg-gray-800/30 p-6 rounded-lg backdrop-blur-sm border border-gray-700">
                <h3 className="text-lg font-medium mb-2 text-[#02F199]">What platforms is RIVALS available on?</h3>
                <p className="text-gray-300">
                  RIVALS will be available on major web browsers, with dedicated mobile apps coming soon after launch.
                </p>
              </div>
              
              <div className="bg-gray-800/30 p-6 rounded-lg backdrop-blur-sm border border-gray-700">
                <h3 className="text-lg font-medium mb-2 text-[#02F199]">Is RIVALS free to play?</h3>
                <p className="text-gray-300">
                  RIVALS will have both free and premium features. Our core gameplay experience will always be accessible to all users.
                </p>
              </div>
              
              <div className="bg-gray-800/30 p-6 rounded-lg backdrop-blur-sm border border-gray-700">
                <h3 className="text-lg font-medium mb-2 text-[#02F199]">How can I become a partner?</h3>
                <p className="text-gray-300">
                  For partnership inquiries, please select "Partnership" in the contact form subject and provide details about your organization.
                </p>
              </div>
            </div>
          </div>
